...
import com.cz.yingpu.system.fuyoudata.AppRegReqData;
import com.cz.yingpu.system.fuyoudata.AppSignCardReqData;
import com.cz.yingpu.system.fuyoudata.AppTransReqData;
import com.cz.yingpu.system.fuyoudata.ArtifRegReqData;
import com.cz.yingpu.system.fuyoudata.AuthConfigReqData;
import com.cz.yingpu.system.fuyoudata.CancelUserForPageReqData;
import com.cz.yingpu.system.fuyoudata.CashWithSetReqData;
import com.cz.yingpu.system.fuyoudata.CashWithSetRspData;
import com.cz.yingpu.system.fuyoudata.ChangeCard2ReqData;
import com.cz.yingpu.system.fuyoudata.CommonRspData;
import com.cz.yingpu.system.fuyoudata.FreezeReqData;
import com.cz.yingpu.system.fuyoudata.ModifyMobileReqData;
import com.cz.yingpu.system.fuyoudata.PreAuthCancelReqData;
import com.cz.yingpu.system.fuyoudata.PreAuthReqData;
import com.cz.yingpu.system.fuyoudata.PreAuthRspData;
...
import com.cz.yingpu.system.fuyoudata.QueryCzTxReq;
import com.cz.yingpu.system.fuyoudata.QueryCzTxRspData;
import com.cz.yingpu.system.fuyoudata.QueryCzTxRspDetailData;
import com.cz.yingpu.system.fuyoudata.QueryDetail;
import com.cz.yingpu.system.fuyoudata.QueryOpResultSet;
import com.cz.yingpu.system.fuyoudata.QueryReqData;
import com.cz.yingpu.system.fuyoudata.QueryRspData;
import com.cz.yingpu.system.fuyoudata.QueryTxnReqData;
import com.cz.yingpu.system.fuyoudata.QueryTxnRspData;
import com.cz.yingpu.system.fuyoudata.QueryTxnRspDetailData;
import com.cz.yingpu.system.fuyoudata.QueryUserInfsReqData;
import com.cz.yingpu.system.fuyoudata.QueryUserInfsRspData;
import com.cz.yingpu.system.fuyoudata.QueryUserInfsRspDetailData;
...
import com.cz.yingpu.system.fuyoudata.ResetPassWordReqData;
import com.cz.yingpu.system.fuyoudata.ReturnLoginReqData;
import com.cz.yingpu.system.fuyoudata.TransferBmuAndFreezeReqData;
import com.cz.yingpu.system.fuyoudata.TransferBmuReqData;
import com.cz.yingpu.system.fuyoudata.UnFreezeRspData;
import com.cz.yingpu.system.fuyoudata.UserChangeCardData;
import com.cz.yingpu.system.fuyoudata.WebArtifRegReqData;
import com.cz.yingpu.system.fuyoudata.WebRegReqData;
import com.cz.yingpu.system.fuyoudata.WtRechargeReqData;
import com.cz.yingpu.system.fuyoudata.WtRechargeRspData;
import com.cz.yingpu.system.fuyoudata.WtWithdrawReqData;
import com.cz.yingpu.system.fuyoudata.WtWithdrawRspData;
import com.cz.yingpu.system.fuyoudata.Wy500012ReqData;
import com.cz.yingpu.system.fuyoudata.P2p500405ReqData;
import com.cz.yingpu.frame.util.fuyou.HttpClientHelper;
import com.cz.yingpu.frame.util.fuyou.HttpPoster;
import com.cz.yingpu.frame.util.fuyou.WebUtils;
import com.cz.yingpu.frame.util.fuyou.ConfigReader;
import com.cz.yingpu.frame.util.fuyou.Object2Xml;
import com.cz.yingpu.frame.util.fuyou.SecurityUtils;
...
public class FuiouService {
	...
	public static QueryBalanceRspData balanceAction(QueryBalanceReqData queryBalanceReqData) throws Exception{
		...
		System.out.println("流水号"+queryBalanceReqData.getMchnt_txn_ssn());
	...
	public static void wy500012(Wy500012ReqData wy500012ReqData,HttpServletResponse response) throws Exception{
		...
		/*	wy500012ReqData.setIss_ins_cd("0803030000");
		paramMap.put("iss_ins_cd","0803030000");*/
	 ...
	 * 用户直连更换银行卡接口
	 */
	public static  CommonRspData  appReplaceBankCard(UserChangeCardData userChangeCardData,HttpServletResponse response,String [] names) throws Exception{
		if(userChangeCardData==null){
			throw new Exception("请求参数为空");
		}
		Map<String,String> paramMap = new HashMap<String, String>();
		paramMap.put("mchnt_cd", StringUtil.isEmpty(userChangeCardData.getMchnt_cd())?"":userChangeCardData.getMchnt_cd().trim());
		paramMap.put("mchnt_txn_ssn", StringUtil.isEmpty(userChangeCardData.getMchnt_txn_ssn())?"":userChangeCardData.getMchnt_txn_ssn().trim());
		paramMap.put("login_id", StringUtil.isEmpty(userChangeCardData.getLogin_id())?"":userChangeCardData.getLogin_id().trim());
		paramMap.put("city_id", StringUtil.isEmpty(userChangeCardData.getCity_id())?"":userChangeCardData.getCity_id().trim());
		paramMap.put("bank_cd", StringUtil.isEmpty(userChangeCardData.getBank_cd())?"": userChangeCardData.getBank_cd().trim());
		paramMap.put("card_no", StringUtil.isEmpty(userChangeCardData.getCard_no())?"":userChangeCardData.getCard_no().trim());
		paramMap.put("signature", SecurityUtils.sign(userChangeCardData.createSignValue()));
		String result=HttpClientHelper.httpFile(ConfigReader.getConfig("jzhUrl")+"/userChangeCard.action", paramMap, names);
