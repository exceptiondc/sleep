 ...
 * @see com.cz.yingpu.system.entity.ContractSample
 */
@Table(name="t_contract_sample")
public class ContractSample  extends BaseEntity {
    ...
    */
	...
	@WhereSQL(sql="id=:ContractSample_pic")
...
private java.util.Date postTime;
	...
	@WhereSQL(sql="weight=:ContractSample_postTime")
	...
	@WhereSQL(sql="weight=:ContractSample_weight")
	...
	@Id
     @WhereSQL(sql="id=:ContractSample_id")
	...
	public void setTitle(java.lang.String value) {
     ...
     @WhereSQL(sql="title=:ContractSample_title")
	...
	public void setDescr(java.lang.String value) {
     ...
     @WhereSQL(sql="descr=:ContractSample_descr")
	...
	public void setContent(java.lang.String value) {
     ...
     @WhereSQL(sql="content=:ContractSample_content")
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
     @WhereSQL(sql="createDate=:ContractSample_createDate")
	...
	public boolean equals(Object obj) {
		if(obj instanceof ContractSample == false) return false;
		if(this == obj) return true;
		ContractSample other = (ContractSample)obj;
