 ...
 * @see com.cz.yingpu.system.entity.News
 */
@Table(name="t_news")
public class News  extends BaseEntity {
    ...
    */
	...
	@WhereSQL(sql="weight=:News_postTime")
	...
	@WhereSQL(sql="weight=:News_weight")
	...
	public void setContent(java.lang.String value) {
     ...
     @WhereSQL(sql="content=:News_content")
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
     @WhereSQL(sql="createDate=:News_createDate")
