...
public class QueryOpResultSet {
	...
	private List<com.cz.yingpu.system.fuyoudata.QueryDetail> details = new ArrayList<com.cz.yingpu.system.fuyoudata.QueryDetail>();
	@Override
	...
	public List<com.cz.yingpu.system.fuyoudata.QueryDetail> getDetails() {
		return details;
	}
	public void setDetails(List<com.cz.yingpu.system.fuyoudata.QueryDetail> details) {
