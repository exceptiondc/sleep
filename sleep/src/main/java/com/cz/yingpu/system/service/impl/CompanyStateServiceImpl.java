 ...
 * @see com.cz.yingpu.system.service.impl.CompanyState
 */
@Service("companyStateService")
public class CompanyStateServiceImpl extends BaseSpringrainServiceImpl implements IAnnounceService {

   
    @Override
	public String  save(Object entity ) throws Exception{
	      CompanyState CompanyState=(CompanyState) entity;
	       return super.save(CompanyState).toString();
	}

    @Override
	public String  saveorupdate(Object entity ) throws Exception{
	      CompanyState CompanyState=(CompanyState) entity;
		 return super.saveorupdate(CompanyState).toString();
	}
	
	@Override
    public Integer update(IBaseEntity entity ) throws Exception{
	 CompanyState CompanyState=(CompanyState) entity;
	return super.update(CompanyState);
    }
 ...
 */
	...
	public CompanyState findCompanyStateById(Object id) throws Exception {
		 return super.findById(id,CompanyState.class);
	}
