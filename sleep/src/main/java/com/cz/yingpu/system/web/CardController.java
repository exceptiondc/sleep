 ...
 * @see com.cz.yingpu.system.web.Card
 */
@Controller
...
public class CardController  extends BaseController {
	...
	ReturnDatas lookjson(Model model,HttpServletRequest request,HttpServletResponse response) throws Exception {
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		  ...
		  List<Hotel> hlist=   cardService.queryForList(new Finder("select id,name from t_hotel"), Hotel.class);
		 card.setHotels(hlist);
		 List<HotelBrand> hblist= cardService.queryForList(new Finder("select id,name from t_hotelBrand"), HotelBrand.class);
		 card.setHotelBrands(hblist);
