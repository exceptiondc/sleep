 ...
 * @see com.cz.yingpu.system.service.impl.ContractSample
 */
@Service("contractSampleService")
public class ContractSampleServiceImpl extends BaseSpringrainServiceImpl implements IAnnounceService {

   
    @Override
	public String  save(Object entity ) throws Exception{
	      ContractSample ContractSample=(ContractSample) entity;
	       return super.save(ContractSample).toString();
	}

    @Override
	public String  saveorupdate(Object entity ) throws Exception{
	      ContractSample ContractSample=(ContractSample) entity;
		 return super.saveorupdate(ContractSample).toString();
	}
	
	@Override
    public Integer update(IBaseEntity entity ) throws Exception{
	 ContractSample ContractSample=(ContractSample) entity;
	return super.update(ContractSample);
    }
 ...
 */
	...
	public ContractSample findContractSampleById(Object id) throws Exception {
		 return super.findById(id,ContractSample.class);
	}
