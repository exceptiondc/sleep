...
public class AnnounceServiceImpl extends BaseSpringrainServiceImpl implements IAnnounceService {

   
    @Override
	public String  save(Object entity ) throws Exception{
	      Announce announce=(Announce) entity;
	       return super.save(announce).toString();
	}

    @Override
	public String  saveorupdate(Object entity ) throws Exception{
	      Announce announce=(Announce) entity;
		 return super.saveorupdate(announce).toString();
	}
	
	@Override
    public Integer update(IBaseEntity entity ) throws Exception{
	 Announce announce=(Announce) entity;
	return super.update(announce);
    }
    @Override
