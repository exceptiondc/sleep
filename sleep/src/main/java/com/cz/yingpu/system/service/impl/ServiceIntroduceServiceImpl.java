 ...
 * @see com.cz.yingpu.system.service.impl.ServiceIntroduce
 */
@Service("serviceIntroduceService")
public class ServiceIntroduceServiceImpl extends BaseSpringrainServiceImpl implements IAnnounceService {

   
    @Override
	public String  save(Object entity ) throws Exception{
	      ServiceIntroduce LawRule=(ServiceIntroduce) entity;
	       return super.save(LawRule).toString();
	}

    @Override
	public String  saveorupdate(Object entity ) throws Exception{
	      ServiceIntroduce LawRule=(ServiceIntroduce) entity;
		 return super.saveorupdate(LawRule).toString();
	}
	
	@Override
    public Integer update(IBaseEntity entity ) throws Exception{
	 ServiceIntroduce LawRule=(ServiceIntroduce) entity;
	return super.update(LawRule);
    }
 ...
 */
	...
	public ServiceIntroduce findServiceIntroduceById(Object id) throws Exception {
		 return super.findById(id,ServiceIntroduce.class);
	}
