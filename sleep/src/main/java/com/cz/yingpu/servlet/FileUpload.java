...
public class FileUpload extends HttpServlet {
	...
	//保存文件的文件夹名称
	private static final String uploadDirName="yingpu";
	private static final String realpath="/webdata/app/";
	private static final String realfilepath= realpath+uploadDirName;
	//http地址
	private static final String httppath="http://114.215.130.18:22222/";
...
//		}
		...
		for (FileItem item : fileitems) {
			...
			if ((isImg && item.getSize() > 1024 * 1024 * 1)	
					|| (isExcel && item.getSize() > 1024 * 1024 * 20)) {
				out.print("上传出错: 文件大小超出系统限制！");
				return;
			}
